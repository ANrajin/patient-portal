...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PatientPortal.Domain.Entities.AllergiesDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PatientPortal.Domain.Entities.Allergy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PatientPortal.Domain.Entities.NCD", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PatientPortal.Domain.Entities.NCDDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PatientPortal.Domain.Entities.AllergiesDetail", b =>
                {
                    b.HasOne("PatientPortal.Domain.Entities.Allergy", "Allergy")
                        .WithMany()
                        .HasForeignKey("AllergyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PatientPortal.Domain.Entities.Patient", "Patient")
            ...
            modelBuilder.Entity("PatientPortal.Domain.Entities.NCDDetail", b =>
                {
                    b.HasOne("PatientPortal.Domain.Entities.NCD", "NCD")
                        .WithMany()
                        .HasForeignKey("NCDId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
